...
(function(root, factory) {
	...
	Paging.prototype = {
		...
		format: function() {
			...
			if (this.pagecount > 6) {
				html += '<li data-page="1" class="ui-pager yema">1</li>';
				if (this.current <= 2) {
					html += '<li data-page="2" class="ui-pager yema">2</li>';
					html += '<li data-page="3" class="ui-pager yema">3</li>';
				...
				if (this.current > 2 && this.current <= this.pagecount - 2) {
					...
					html += '<li data-page="' + (this.current - 1) + '" class="ui-pager yema">' + (this.current - 1) + '</li>';
					html += '<li data-page="' + this.current + '" class="ui-pager yema">' + this.current + '</li>';
					html += '<li data-page="' + (this.current + 1) + '" class="ui-pager yema">' + (this.current + 1) + '</li>';
					html += '<li class="ui-paging-ellipse" class="ui-pager">' + this.settings.ellipseTpl + '</li>';
				} else {
					html += '<li class="ui-paging-ellipse" >' + this.settings.ellipseTpl + '</li>';
					for (var i = this.pagecount - 2; i < this.pagecount; i++) {
						html += '<li data-page="' + i + '" class="ui-pager yema">' + i + '</li>'
					}
				}
				html += '<li data-page="' + this.pagecount + '" class="ui-pager yema">' + this.pagecount + '</li>';
			} else {
		...
		bindToolbar: function() {
			var _this = this;
			var html = $('<li class="ui-paging-toolbar"><select class="ui-select-pagesize"></select><input type="text" class="ui-paging-count"/><a href="javascript:void(0)">跳转</a></li><li>共</li><li class="nums"></li><li>条数据</li>');
