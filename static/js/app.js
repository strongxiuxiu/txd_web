...
$('.sidebar-nav-sub-title').on('click', function() {
    console.log(111)
    $(this).siblings('.sidebar-nav-sub').slideToggle(10)
        .end()
...
//     let index_btn = `<button type="button" class="am-btn am-btn-default case_manage">
//     <a  href="/auction/case/manage">案件管理</a>
//     </button>
//     <button type="button" class="am-btn am-btn-default case_de">
//         <i>x</i>
//     </button>`
//     $(".showbtns").append(index_btn)
// })
// $(".index_de").click(function(){
//   console.log(111)
// })
// $(document).ready(function (){
//     $("li").each(function(index){
//         $(this).click(function(){ 
//             $("li").addClass("join_first");
//             $("li").eq(index).removeClass("join_first");
//         });
//     });
//    });